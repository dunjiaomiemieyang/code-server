...
export interface IMenuRegistry {
	 ...
	 */
	appendMenuItems(items: Iterable<{ id: MenuId; item: IMenuItem | ISubmenuItem, disabledTencent?: 'tencent' }>): IDisposable;
	appendMenuItem(menu: MenuId, item: IMenuItem | ISubmenuItem, disabledTencent?: 'tencent'): IDisposable;
...
export const MenuRegistry: IMenuRegistry = new class implements IMenuRegistry {
	...
	appendMenuItem(id: MenuId, item: IMenuItem | ISubmenuItem, disabledTencent?: 'tencent'): IDisposable {
		if (disabledTencent === 'tencent') {
			return markAsSingleton(toDisposable(() => { }));
		}
	...
	appendMenuItems(items: Iterable<{ id: MenuId; item: IMenuItem | ISubmenuItem, disabledTencent?: 'tencent' }>): IDisposable {
		...
		for (const { id, item, disabledTencent } of items) {
			result.add(this.appendMenuItem(id, item, disabledTencent));
		}
		return result;
	}
